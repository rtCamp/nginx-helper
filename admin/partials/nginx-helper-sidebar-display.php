...
<form id="purgeall" action="" method="post" class="clearfix">
    <a href="<?php echo $nonced_url; ?>" class="button-primary">
        <?php _e( 'Purge Entire Cache', 'nginx-helper' ); ?>
    </a>
</form>
<div class="postbox" id="support">
    ...
    <div class="inside">
        <p>
            <?php 
                printf(
                    __( 'Please use our <a href="%s">free support forum</a>.',
                    'nginx-helper'),
                    'http://rtcamp.com/support/forum/wordpress-nginx/'
                ); 
            ?>
        </p>
    </div>
...
<div class="postbox" id="social">
    <h3 class="hndle">
        <span>
            <?php _e( 'Getting Social is Good', 'nginx-helper' ); ?>
        </span>
    </h3>
