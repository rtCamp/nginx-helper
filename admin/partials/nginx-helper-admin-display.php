...
<div class="wrap rt-nginx-wrapper">
    <h2 class="rt_option_title">
        <?php _e('Nginx Settings', 'nginx-helper'); ?>
    </h2>
    <div id="poststuff">
        <div id="post-body" class="metabox-holder columns-2">
            <div id="post-body-content">
                ...
                foreach ( $this->settings_tabs as $setting_tab => $setting_name ) {
                    ...
                    echo '<a class="nav-tab' . $class . '" href="?page=nginx&tab=' . $setting_name['menu_slug'] . '">' . $setting_name['menu_title'] . '</a>';
                }
                echo '</h2>';
            ...
            <div id="postbox-container-1" class="postbox-container">
                <?php 
                    include 'nginx-helper-sidebar-display.php';
                ?>
